...
Technical Note: While Jsoup's core engine is natively built around CSS Selectors, XPath was deliberately chosen for this PoC to experiment with these technical requirements and to demonstrate node navigation.
